...
{ 
    ...
    {
       EventsManager.instance.gameEvents.onADHDTriggered += AssignTarget; 
       EventsManager.instance.gameEvents.onAnxietyTriggered += AnxietyCamera; 
       EventsManager.instance.miscEvents.onCampfireActivated += NormalCamera; 
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(_Input) && !GetComponent<ADHD>().hyper)
        {
            AssignTarget();
        }
    }
    ...
    private void AnxietyCamera()
    {
        cinemachineFreeLook.m_Orbits[0].m_Radius = 2f;
        cinemachineFreeLook.m_Orbits[1].m_Radius = 1.5f;
        cinemachineFreeLook.m_Orbits[2].m_Radius = 2f;
    }
    private void NormalCamera()
    {
        cinemachineFreeLook.m_Orbits[0].m_Radius = 4f;
        cinemachineFreeLook.m_Orbits[1].m_Radius = 3f;
        cinemachineFreeLook.m_Orbits[2].m_Radius = 4f;
    ...
    private GameObject ClosestTarget() // this is modified func from unity Docs ( Gets Closest Object with Tag ). 
    {
        ...
        gos = GetComponent<ADHD>().GetFocusableObject();
